        ...
        <header className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-8 border-b-2 border-amber-900/10 pb-6">
          ...
          <div className="flex bg-amber-900/5 p-1 rounded-xl border border-amber-950/10 self-start md:self-center">
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold transition-all cursor-pointer ${viewMode === "map"
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold transition-all cursor-pointer ${viewMode === "grid"
                  ? "bg-amber-900 text-white shadow-md"
                  : "text-amber-900 hover:bg-amber-900/10"
                }`}
            >
                      ...
                      return (
                        ...
                        >
                          ...
                          <text
                            ...
                            y={group.y - 10}
                            textAnchor="middle"
                            className={`text-[8px] font-black select-none pointer-events-none fill-amber-950 drop-shadow-md transition-all duration-300 ${isSelected ? "text-[10px] font-black scale-105" : "opacity-80"
                              }`}
                          >
                            {group.cityName}
